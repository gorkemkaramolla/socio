    ...
    return (
        <div className={'flex justify-center gap-10'}>
            <div className={'h-full w-3/5 flex flex-col'}>
                <div className={'flex items-center gap-3 bg-white w-full  min-h-[110px] my-4 shadow-2xl px-10 overflow-y-hidden overflow-x-auto rounded-xl'}>
                    <Stories/>
                    <Stories/>
                    <Stories/>
                    <Stories/>
            ...
            <div className={'h-full w-1/5 flex flex-col items-center'}>
                ...
                <div className={'w-full flex bg-red-500 text-white min-h-[350px] my-4 shadow-2xl rounded-xl'}>
                    2222
                </div>
                <div className={'w-full'}>
                    <Heading
                ...
                <div className={'w-full flex bg-red-500 text-white min-h-[250px] my-4 shadow-2xl rounded-xl'}>
                    2222
                </div>
            </div>
        </div>
