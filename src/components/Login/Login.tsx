...
const LoginPage: React.FC<Props> = () => {
  ...
  return (
    <div className='justify-center p-12   w-[100%] h-[100%] flex flex-col  items-center'>
      <div className='gap-3 flex flex-col md:p-12  p-5    rounded-xl'>
        <div className='flex flex-col gap-8'>
          <Heading size={'lg'} weight={'bold'} align={'center'} heading='h1'>
            Login
          </Heading>
          <Paragraph className='text-lg' align={'center'}>
          ...
          <form
            className='flex relative flex-col gap-12 w-[350px] md:w-[400px]'
              ...
              <div className='flex flex-col w-full '>
                <div className='flex '>
                  ...
                  <span
                    ...
                    style={{ flex: '0.1' }}
                    className='text-slate-200 flex justify-center items-center  relative cursor-pointer'
                  >
                    {PwClose ? (
                      <svg
